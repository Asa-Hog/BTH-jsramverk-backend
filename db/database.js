...
const database = {
        ...
        // let dsn = `mongodb+srv://${config.username}:${config.password}@cluster0.rgvmt.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;

        // let dsn = `mongodb+srv://editor:pass@cluster-bth-jsramverk-e.yic4yta.mongodb.net/?retryWrites=true&w=majority`;
